...
root.geometry("650x121")

################################################### CREATING WIDGETS ############################################################

# Creating a label widget
myLabel1 = Label(root, text='Input Folder')
myLabel2 = Label(root, text='Output Folder')
...
# Creating a label widget
myLabel1 = Label(root, text='Input Folder', pady=3)
myLabel2 = Label(root, text='Output Folder', pady=3)             
...
def BrowseIn():
    ...
    mylabel6 = Label(root, text='Input Folder Selected!', width=50, anchor="center", background='white').grid(row=2, column=1,
       columnspan = 2)
    myButton2 = Button(root, text="ANALYZE", pady=3,state=NORMAL, padx=60, command=Analyze)
...
# Create fcn to Browse output
def Analyze():
    myButton4 = Button(root, text="EXPORT SUMMARY", pady=3,state=NORMAL, padx=32, command=Export)
...
def Export():
    ...
    # Open destination folder
        os.system('start '+outputFolder+'/'+folder)
...
myButton2 = Button(root, text="ANALYZE", pady=3,state=DISABLED, padx=60, command=Analyze).grid(row=3, column=1, padx=1, pady=1) #padx: anchura
myButton4 = Button(root, text="EXPORT SUMMARY", pady=3,state=DISABLED, padx=32, command=Export).grid(row=3, column=2, padx=1, pady=1) #padx: anchura
